...
# [9,7,5,3,2,1]
# Henter verdi [0], replacer den med [5], deretter setter verdi [0] til [5]
...
# Funksjonen returnerer listen med en tilfeldig rekkefølge (shuffle)
...
# Fra -2 fra høyre, til 6 fra venstre = "7"
...
# Sorterer liste 1
# Deklarerer liste 2
# Deklarerer liste 3, med liste 1 + liste 2
# Setter inn "10" på posisjon [9] på liste 3
# Fjærner "1"s fra liste 3
# reverserer listen
# printer liste 3
# [10, 9, 8, 7, 6, 5, 4, 3, 2]
