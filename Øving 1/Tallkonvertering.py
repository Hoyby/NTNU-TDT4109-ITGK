...
helt1 = int(input("Skriv inn et heltall. "))
print("konvertert til flyttall blir det: ", float(helt1))
...
alder= input("hei, %s, hvor gammel er du? " %navn)
progAlder= input("Hvor gammel var du da du begynte å programmere? ")
progÅr = int(float(alder))-int(float(progAlder))
print("Da har du programmert i", progÅr, "år")
Givende= input("Syntes du de %s årene har vært givende? " %progÅr)
...
print("Heltall fra int() konvertert tilbake til flyttall:", float(tall))
...
print("Tallet du skrev er", tall, "og med", desimaler, "desimaler blir det til", round(tall, desimaler))
