...
print(input("favorittfag? "), "intressant!")
...
print("Omkrets av sirkelen:", topir)  #tau er det samme som 2 pi
print("Areal av sirkelen:", pir)
print("Areal av sylinderen:", topir * 7.9 + 2 * pir)
