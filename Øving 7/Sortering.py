...
en_liste = [9, 1, 34, 7, 2, 3, 45, 6, 78, 56, 36, 65, 33, 21, 23, 34, 45, 6]
...
def selection_sort(liste):
    ...
    for i in range(0, len(liste)):
        index_of_largest_int = liste.index(max(liste))
        new_element = (liste[index_of_largest_int])
        sorted_list.insert(0, new_element)
        liste.pop(index_of_largest_int)
    return sorted_list
...
# selection_sort er veldig mye mer optimal
